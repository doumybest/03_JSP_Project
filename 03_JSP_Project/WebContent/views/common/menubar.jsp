...
<%
	...
	// 로그인 전이라면 null값, 로그인 성공이라면, loginUser에는 회원 정보가 담긴 Member객체가 들어감
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<script>
		...
		if(msg != "null") {
			alert(msg);
			// 알림창을 띄워준 후 session에 담긴 해당 메세지는 지워야 함
			// 안그러면 menubar.jsp가 로딩될 때마다 항상 메세지가 뜰 것
	...
	<div class="Login-area">
		...
		<script>
			function enrollPage() {
				...
				// 단순한 정적인 페이지 요청일지라도 반드시 servlet을 거쳐가도록 작성할 것
	...
	<div class="nav-area" align="center">
		...
		<div class="menu"><a href="<%= contextPath %>/list.bo">일반 게시판</a></div>
